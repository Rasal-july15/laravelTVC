        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{ route('allcategory') }}"><i class="icon-envelope"></i><span class="hidden-tablet"> Categories </span></a></li>
                    <li><a href="{{ route('allbrand') }}"><i class="icon-tasks"></i><span class="hidden-tablet"> Brands </span></a></li>
                    <li><a href="{{ route('allproduct') }}"><i class="icon-eye-open"></i><span class="hidden-tablet"> Products</span></a></li>
                    <li><a href="{{ route('slider') }}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Slider </span></a></li>
                    <li><a href="{{ route('icon') }}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Social Icons </span></a></li>
                    <li><a href="{{ route('navmenu') }}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Nav Menu  </span></a></li>
                    <li><a href="{{ route('allmember') }}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Team Members </span></a></li>
                    <li>
